"use strict";
//This script is going to change the largest picture in the gallery by the one which is going to be pressed in the thumbnails
	function gallery(){
...
//This stops the full image from opening if clicked
$(document).ready(function() {
	$('#images_full img').click(function(event){
